...
pub mod window {
    ...
    impl<P, S, T, U, V, W, X> WgpuSevenWindowApp<P, S, T, U, V, W, X> {
            ...
            X: FrameProducer + 'static,
        {
            ...
            let _windows = [
                primary, secondary, tertiary, quaternary, senary, quinary, septenary,
            ];
